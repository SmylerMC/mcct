...
public class MCCTConfigScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        DrawableHelper.drawCenteredText(matrices, this.textRenderer, I18n.translate(MCCT.MOD_ID + ".configscreen.title"), this.width/2, 20, 0xFFFFFFFF);
        DrawableHelper.drawCenteredText(matrices, this.textRenderer, I18n.translate(MCCT.MOD_ID + ".configscreen.tweakconfig"), this.width/4 * 3, 50, 0xFFFFFFFF);
